...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ActivatePopupOnUpdate_MetaData[];
#endif
		static void NewProp_ActivatePopupOnUpdate_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ActivatePopupOnUpdate;
#if WITH_METADATA
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_RibbonPushOutside_MetaData[];
#endif
		static void NewProp_RibbonPushOutside_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_RibbonPushOutside;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivatePopupOnUpdate_MetaData[] = {
		{ "Category", "Activation" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivatePopupOnUpdate = { "ActivatePopupOnUpdate", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UElectronicNodesSettings), &Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivatePopupOnUpdate_SetBit, METADATA_PARAMS(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivatePopupOnUpdate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivatePopupOnUpdate_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_RibbonPushOutside_MetaData[] = {
		{ "Category", "Ribbon Style (experimental)" },
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_RibbonPushOutside = { "RibbonPushOutside", nullptr, (EPropertyFlags)0x0010000000004001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UElectronicNodesSettings), &Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_RibbonPushOutside_SetBit, METADATA_PARAMS(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_RibbonPushOutside_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_RibbonPushOutside_MetaData)) };
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_PluginVersionUpdate_MetaData[] = {
		{ "Comment", "/* Internal value to fix elements on plugin update. */" },
		{ "ModuleRelativePath", "Public/ElectronicNodesSettings.h" },
		{ "ToolTip", "Internal value to fix elements on plugin update." },
	};
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_PluginVersionUpdate = { "PluginVersionUpdate", nullptr, (EPropertyFlags)0x0010000000004000, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UElectronicNodesSettings, PluginVersionUpdate), METADATA_PARAMS(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_PluginVersionUpdate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_PluginVersionUpdate_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UElectronicNodesSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_ActivatePopupOnUpdate,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_RibbonPushOutside,
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UElectronicNodesSettings_Statics::NewProp_PluginVersionUpdate,
	};
	...
	IMPLEMENT_CLASS(UElectronicNodesSettings, 3780848639);
